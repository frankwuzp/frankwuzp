...
- [SivanLaai/rime-pure](https://github.com/SivanLaai/rime-pure) - 基于 Rime（小狼毫 / 同文）的极简、优雅、好用的中英文输入方案整合包。 包含：四叶草九宫格拼音 / 四叶草拼音 / 小鹤双拼 / 极品五笔 / QQ五笔 / 徐码 / 郑码 等主流方案。
...
- [ipruning/IADB](https://github.com/ipruning/IADB) - 信息分析学术数据库协作项目，用于收集学者元数据，并沉淀词条添加流程与信息源实践
...
- [s010s/prehistoric-animal-museum](https://github.com/s010s/prehistoric-animal-museum) - A calm, parent-and-child 3D prehistoric animal museum.
